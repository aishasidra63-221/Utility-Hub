...
const ALL_TOOLS = [
  ...
  },
  {
    ...
    icon: Film,
    title: "Video to GIF",
    description: "Convert any video clip to an animated GIF. Trim, set FPS and size — all in your browser, no uploads.",
    badge: "New",
    category: "generator" as Category,
    gradient: "from-violet-500/15 to-purple-500/5",
    iconColor: "text-white",
  ...
  },
  {
    ...
    description: "Focus for 25 minutes, then take a break. Session counter, sound alert, and progress ring — all in your browser.",
    badge: "Focus",
    category: "generator" as Category,
  ...
  },
  {
    ...
    description: "Calculate your Body Mass Index with metric or imperial units. See your category, ideal weight range, and health advice.",
    badge: "Metric & Imperial",
    category: "utility" as Category,
    gradient: "from-sky-500/15 to-blue-500/5",
    iconColor: "text-white",
    iconBg: "bg-gradient-to-br from-sky-500 to-blue-600 shadow-lg shadow-sky-500/30",
    accentColor: "group-hover:text-sky-500",
    borderGradient: "from-sky-500 to-blue-400",
  },
  {
    href: "/emi-calculator",
    id: "emi-calculator",
    ...
    description: "Calculate monthly loan EMI, total interest, and full amortization schedule. Supports home, car, and personal loans.",
    badge: "With charts",
    category: "utility" as Category,
    gradient: "from-violet-500/15 to-purple-500/5",
    iconColor: "text-white",
  ...
  },
  {
    ...
    icon: Braces,
    title: "JSON Explorer",
    description: "Paste or upload JSON to explore it with a collapsible tree, type stats, array table view, and formatter. 100% private.",
    badge: "Tree & Table",
    category: "utility" as Category,
    gradient: "from-amber-500/15 to-orange-500/5",
    iconColor: "text-white",
  ...
  },
  {
    ...
    description: "Encode text or any file to Base64, or decode Base64 back to text. Supports images, PDFs, drag & drop. Browser-only.",
    badge: "File support",
    category: "utility" as Category,
    gradient: "from-rose-500/15 to-pink-500/5",
    iconColor: "text-white",
